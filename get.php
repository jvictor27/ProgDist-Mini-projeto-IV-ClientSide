<?php 
	...
	if(isset($_GET['id'])){
		...
		$response = Unirest\Request::get($url_server, $headers, $query);
		// echo '<pre>';
		// var_dump($response);
		// echo '</pre>';
		// exit;
		...
		if($response->code == 404){
			$msg['error'] = 'Erro, noticia não encontrada!';			
		}
	}
?>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active" ><a href="get.php">Buscar notícia</a></li>
      </ul>
	...
	<div class="container">
		<div class="row text-center"><h3>Buscar uma notícia</h3></div>
		<hr>
		<div class="row">
			...
			<form action="get.php" method="GET">
			  <div class="form-group">
			    ...
			    <input type="text" name="id" class="form-control input-sm" value="<?php echo isset($query['id'])? $query['id'] : '' ?>">
			  </div>
